...
function addNumbers(addNumber1, addnumber2) {
    ...
    document.querySelector('#sum').innerText = add(addNumber1, addnumber2);
...
function divideNumbers (divideNumbers1, divideNumbers2){
    let divideNumbers1 = document.querySelector('#dividend');
    let divideNumbers2 = document.querySelector('#divisor');
